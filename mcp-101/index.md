...
See [docs/RELEASE.md](docs/RELEASE.md) for GPG and SHA256SUMS verification.
...
1. Author formal spec (Agda) → `scripts/check.ps1`
2. Bridge to cutile (append-only cells) → `cargo test -p cutile`
3. Validate with coherence-mcp → WAVE ≥ 0.85
4. Package handoff → `handoff_packet_validate`
5. On anomaly → `trigger_correction_burst`

---

## Full Storyboard (Frames 1–7)

The complete v0.4 paradigm is documented in the [README](../README.md):
...
- [README](../README.md) — Full v0.4 storyboard
- [docs/quick-start.md](../docs/quick-start.md) — Dev setup
- [coherence.toolated.online](https://coherence.toolated.online) — Sovereign command center
- [LogOS](https://github.com/toolate28/LogOS) — Formal Agda + cutile layer
- npm: [@toolated/coherence-mcp](https://www.npmjs.com/package/@toolated/coherence-mcp)
